...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="/my_shop/login" method="post">
            <div class="form-group has-feedback">
                <input type="email" class="form-control" placeholder="邮箱" name="email" value="${email}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="isRemember" checked="${isRemember}"> 记住我
                        </label>
                    </div>
                </div>
                <div class="col-xs-4">
